...
class ExampleJobB implements ShouldQueue
{
    ...
    {
        Log::info('ExampleJobB executed for user id: ' . $this->user->getId());
        ...
        try {
            ...
            Log::error('ExampleJob failed: ' . $e->getMessage());
